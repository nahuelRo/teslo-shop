...
export const AddressForm = ({ countries, userStoreAddress = {} }: Props) => {
  ...
  const {
    ...
    defaultValues: {
      ...userStoreAddress,
      rememberAddress: !!userStoreAddress?.firstName,
    },
  });
  ...
  const handleRememberAddressChange = () => {
    setWasTouched(true);
  };
      ...
      <div className="inline-flex items-center mb-10">
        ...
        >
          <input
            ...
            onChange={handleRememberAddressChange} // Actualizamos si el checkbox fue tocado
          />
